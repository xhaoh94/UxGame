...
{
	public partial class ResDebuggerWindow
	{
		...
		{
			var _visualAsset = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Assets/Editor/Debugger/Res/Uxml/ResDebuggerWindow.uxml");
