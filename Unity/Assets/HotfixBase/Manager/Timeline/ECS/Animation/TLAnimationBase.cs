...
namespace Ux
{
    public class TLAnimationBase:Entity
    {
        ...
        public float Duration
        {
            set
            {
                _source.SetDuration(value);
            }
            get
            {
                return (float)_source.GetDuration();
            }
        }
        ...
        protected void SetSourcePlayable(PlayableGraph graph, Playable playable)
        {
            _graph = graph;
            _source = playable;
        }
