...
public class DualKawaseBlurRenderFeature : ScriptableRendererFeature
{
    ...
    public class DualKawaseBlurPass : ScriptableRenderPass
    {
        ...
        {
            renderPassEvent = evt;
            Shader dualKawaseBlurShader = Shader.Find("Ux/URP_PostProcessing/DualKawaseBlur");
            if (dualKawaseBlurShader)
            {
                dualKawaseBlurMat = CoreUtils.CreateEngineMaterial(dualKawaseBlurShader);
            }
    ...
    {
        _dualKawaseBlurPass = new DualKawaseBlurPass(renderPassEvent);
    }
