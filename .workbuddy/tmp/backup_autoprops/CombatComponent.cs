...
namespace Ux
{
    ...
    public sealed class CombatComponent : Entity, IAwakeSystem, ICombatEntity
    {
        ...
        public void TickLogic(long frame, in CombatFrameCommands commands)
        {
            ...
            _framePlan = CombatTimelineResolver.Resolve(Profile, Controller.StateMachine, Controller.ActionRunner, _presentationVariant);
        ...
        private bool RefreshTimeline(bool force)
        {
            ...
            EnsureTimelinePlayer();
            var nextPlan = CombatTimelineResolver.Resolve(Profile, Controller.StateMachine, Controller.ActionRunner, _presentationVariant);
